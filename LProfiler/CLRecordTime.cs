...
namespace LGame.LProfiler
{
    ...
    public class CLRecordTime : ALWatch, ILWatch
    {
        /// <summary>
        /// 开始观察
        /// </summary>
        ...
        public double EndWatch()
        {
            ...
            if (entity == null)
            {
                SLConsole.WriteError("观察还未开始...");
                return 0;
            }
            entity.IsWatch = false;
            entity.EndTime = Time.realtimeSinceStartup;
            SLConsole.Write(string.Format(" [RecordTime] {0} use {1}s.", entity.WatchKey, entity.DiffTime));
